...
class ZbioryDanych(models.Model):
    sesja = models.ForeignKey("Sesja", on_delete=models.CASCADE)
    uczacy = models.ManyToManyField("Obraz")
    walidacyjny = models.ManyToManyField("Obraz", blank=True, null=True)
    testowy = models.ManyToManyField("Obraz", blank=True, null=True)
